...
namespace MVCTutorial.Controllers
{
	public class OrdersController : Controller
	{
		...
		public ActionResult OrderLinesForOrder(int? id) {
			OrderLinesForOrder orderLinesForOrder = new OrderLinesForOrder() {
				Order = db.Orders.Find(id),
				OrderLine = db.OrderLines.Where(orderline => orderline.OrderId == id).ToList()
			};

			return View(orderLinesForOrder);
		}
